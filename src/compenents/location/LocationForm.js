    ...
    <form className="locationForm">
      ...
      <fieldset>
        <div className="form-group">
          ...
          <input type="text" id="address" required autoFocus className="form-control" placeholder="Location address" value={location.breed} onChange={handleControlledInputChange} />
        </div>
      </fieldset>
