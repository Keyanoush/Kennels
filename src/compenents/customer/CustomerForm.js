  ...
  */
  ...
  const handleClickSaveCustomer = (event) => {
    ...
    if (customer.name === "" || customer.address === "") {
      window.alert("Please select an address and a name")
    } else {
    ...
    <form className="customerForm">
      ...
      <fieldset>
        <div className="form-group">
          ...
          <input type="text" id="address" required autoFocus className="form-control" placeholder="Customer address" value={customer.breed} onChange={handleControlledInputChange} />
        </div>
      </fieldset>
